...
. autogpt.sh run --ai-task "$task_prompt" --paper-id "$index" --skip-reprompt --continuous --log-level DEBUG --fast_llm "gpt-4o-2024-05-13" --smart_llm "gpt-4o-2024-05-13" --openai_cost_budget 5 2>&1 | tee ./environment/$index/output.txt
